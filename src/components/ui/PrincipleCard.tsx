...
export function PrincipleCard({ principle }: { principle: Principle }) {
  return (
    <div className="group h-full p-6 border border-line rounded-lg transition-all duration-200 hover:border-line-strong hover:-translate-y-0.5 hover:shadow-md bg-bg">
